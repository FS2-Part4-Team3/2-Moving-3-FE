...
export default function Notification() {
  return (
    <div className="flex flex-col rounded-[2.4rem] border border-line-200 py-[1rem] px-[1.6rem] w-fit h-[40.2rem]">
      ...
      <div className="overflow-y-auto">
        <div className="flex flex-col w-full pr-[0.5rem]">
          <div className="flex flex-col border-b border-line-200 py-[1.6rem] px-[2.4rem] gap-[0.2rem]">
