  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen flex items-center justify-center bg-black bg-opacity-50 lg:hidden">
        <div className="bg-white w-[37.5rem] rounded-[3.2rem] pt-[1.6rem] pb-[3.2rem] px-[2.4rem] gap-[2.4rem]">
          <div className="flex flex-col gap-[1.2rem]">
            <div className="flex w-full justify-between p-[0.8rem]">
              <div className="flex gap-[2.4rem]">
                <p className="font-bold text-[1.8rem] leading-[2.6rem] text-black-400">
                  이사 유형
                </p>
                <p className="font-bold text-[1.8rem] leading-[2.6rem] text-black-400">
                  필터
