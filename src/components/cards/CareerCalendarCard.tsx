...
export default function CareerCalendarCard({ setCareerDate, setIsCareerOpen, initialCareerDate }: CareerCalendarCardProps) {
  ...
  return (
    <div className="lg:w-[64rem] md:w-[32.7rem] sm:w-[32.7rem] flex flex-col items-center lg:rounded-[3.2rem] md:rounded-[1.6rem] sm:rounded-[1.6rem] lg:py-[2.4rem] md:py-[1.4rem] sm:py-[1.4rem] lg:gap-[2.4rem] md:gap-[1.6rem] sm:gap-[1.6rem] bg-white dark:bg-dark-p border-none ">
