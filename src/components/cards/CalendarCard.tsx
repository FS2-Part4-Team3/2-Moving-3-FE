...
export default function CalendarCard({ setMovingDate, setIsMovingDate, initialMovingDate }: CalendarCardProps) {
  ...
  return (
    <div className="lg:w-[64rem] md:w-[32.7rem] sm:w-[32.7rem] flex flex-col items-center lg:rounded-[3.2rem] md:rounded-[1.6rem] sm:rounded-[1.6rem] lg:py-[2.4rem] md:py-[1.4rem] sm:py-[1.4rem] lg:gap-[2.4rem] md:gap-[1.6rem] sm:gap-[0.8rem] bg-white border-none shadow-custom4">
      ...
      <div className="flex items-center justify-center gap-[7rem] mt-4 ">
        <select
          className="w-[8rem] h-[3rem] text-[1.6rem] sm:text-[1.2rem] cursor-pointer font-medium"
