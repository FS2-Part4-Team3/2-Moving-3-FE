...
export default function AddressCard({ regions, setRegions, handleSubmit }: AddressCardProps) {
  ...
  return (
    <>
      <div className="lg:w-[62.4rem] md:w-[32.7rem] sm:w-[32.7rem] lg:p-[3.2rem] md:p-[3.2rem] sm:p-[1.6rem] flex flex-col gap-[2.1rem] sm:gap-[0.8rem] rounded-[3.2rem] rounded-tr-none border-none bg-white dark:bg-dark-p">
