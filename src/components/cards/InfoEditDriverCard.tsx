...
export default function InfoEditDriverCard({ data }: InfoEditDriverCardProps) {
  return (
    <div className="w-full border border-gray-100 bg-background-100 rounded-[1.6rem] p-[2.4rem] gap-[2.4rem]">
      ...
      <div className="w-full px-[1.8rem] py-[2.4rem] gap-[2.4rem] bg-background-100 border border-line-200 rounded-[0.6rem] shadow-custom11">
        {data.image && (
          <Image
            src={data.image}
            alt="driver"
