...
export default function InfoEditDriverCard({ data }: InfoEditDriverCardProps) {
  return (
    <div className="flex flex-col w-full gap-[1rem]">
      <div className="w-full flex flex-col border-[0.05rem] border-gray-100 bg-background-100 dark:bg-dark-p rounded-[1.6rem] lg:p-[2.4rem] sm:py-[1.6rem] sm:px-[1.4rem] lg:gap-[2.4rem] sm:gap-[1.6rem]">
        <div className="w-full justify-between flex flex-row items-center">
          <div className="flex flex-row gap-[1.6rem] items-center">
            ...
            <div className="flex flex-col gap-[0.8rem]">
              <p className="font-semibold lg:text-[2.4rem] lg:leading-[3.2rem] sm:text-[1.6rem] sm:leading-[2.6rem] text-black-300 dark:text-dark-t">
                {data.name}
              </p>
        ...
        <div className="w-full flex flex-row lg:px-[1.8rem] lg:py-[2.4rem] sm:p-[1rem] lg:gap-[2.4rem] sm:gap-[1.4rem] bg-background-100 dark:bg-dark-p border border-line-200 rounded-[0.6rem] shadow-custom11">
          <Image
            src={data.image || default_profile}
            alt="driver"
            width={80}
          ...
          <div className="flex flex-col gap-[1.6rem]">
            <div className="flex flex-row gap-[1.6rem] items-center font-medium lg:text-[1.6rem] sm:text-[1.3rem] lg:leading-[2.6rem] sm:leading-[2.2rem]">
              <div className="flex flex-row lg:gap-[0.6rem] sm:gap-[0.2rem] items-center">
                ...
                <p className="text-black-300 dark:text-dark-t">{data.rating}</p>
              ...
              <div className="flex flex-row lg:gap-[0.6rem] sm:gap-[0.4rem]">
                ...
                <div className="text-black-300 dark:text-dark-t">{data.career}년</div>
              </div>
              <div className="h-[1.4rem] border border-line-200" />
              <div className="flex flex-row lg:gap-[0.6rem] sm:gap-[0.4rem]">
                <div className="text-black-300 dark:text-dark-t">{data.applyCount}건</div>
            ...
            <div className="flex md:flex-row sm:flex-col lg:gap-[1.6rem] md:gap-[1.4rem] sm:gap-[0.8rem] md:items-center sm:items-start font-normal lg:text-[1.8rem] lg:leading-[2.6rem] sm:text-[1.4rem] sm:leading-[2.4rem]">
              <div className="flex flex-row lg:gap-[1.2rem] sm:gap-[0.8rem] items-center">
                ...
                <div className="text-black-300 dark:text-dark-t">
