...
export default function ReviewTabs() {
  ...
  return (
    <div className="w-screen">
      <div className="w-full md:w-[74.4rem] sm:W-[37.5rem] lg:h-[9.6rem] md:h-[5.4rem] sm:h-[5.4rem] flex items-center lg:gap-[4rem] md:gap-[2.4rem] sm:gap-[2.4rem] bg-white dark:bg-dark-bg shadow-custom7 dark:shadow lg:px-[26rem] lg:py-[3.2rem] md:px-[7.2rem] md:py-[1rem] sm:px-[2.4rem] sm:py-[1rem] ">
