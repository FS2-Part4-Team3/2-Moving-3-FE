...
export default function MyQuoteEditToast({ onClose }: MyQuoteEditToastProps) {
  ...
  return (
    <div className="lg:w-[120rem] md:w-[60rem] sm:w-[32.7rem] rounded-[1.2rem] border border-red-200 lg:gap-[1.6rem] sm:gap-[0.8rem] lg:py-[2.4rem] lg:px-[3.2rem] sm:py-[1rem] sm:px-[2.4rem] flex items-center bg-red-100">
