...
export default function ProfileEditNormalRight({
  ...
  return (
    <div>
      <div className="lg:w-[64rem] border-b lg:pb-[3.2rem] md:pb-[2rem] sm:pb-[2rem] border-line-100 lg:mb-[3.2rem] md:mb-[2rem] sm:mb-[2rem]">
      ...
      <div className="lg:w-[64rem] lg:mb-[6.8rem] md:mb-[2.4rem] sm:mb-[2.4rem]">
        <h3 className="lg:text-[2rem] md:text-[1.6rem] sm:text-[1.6rem] font-semibold lg:text-black-300 mb-[0.8rem]">
